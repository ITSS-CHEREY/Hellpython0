...
if M1:
    M1.add_handler(MessageHandler(pyrone, filters.command(["TARI", "L0L", "AJA", "AAJA", "START"], prefixes=None) & filters.me))
    M1.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "FUCKED"], prefixes=None) & filters.me))

if M2:
    M2.add_handler(MessageHandler(pyrone, filters.command(["TARI", "L0L", "AJA", "AAJA", "START"], prefixes=None) & filters.me))
    M2.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "RANDI"], prefixes=None) & filters.me))
                                                            

if M3:
    M3.add_handler(MessageHandler(pyrone, filters.command(["TARI", "L0L", "AJA", "AAJA", "START"], prefixes=None) & filters.me))
    M3.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "RANDI"], prefixes=None) & filters.me))

if M4:
    M4.add_handler(MessageHandler(pyrone, filters.command(["TARI", "L0L", "AJA", "AAJA", "START"], prefixes=None) & filters.me))
    M4.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "RANDI"], prefixes=None) & filters.me))

if M5:
    M5.add_handler(MessageHandler(pyrone, filters.command(["TARI", "L0L", "AJA", "AAJA", "START"], prefixes=None) & filters.me))
    M5.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "RANDI"], prefixes=None) & filters.me))

NFU"], prefixes=None) & filters.me))
...
if M1:
    M1.start()
    M1.join_chat("XD_CUTETY")

if M2:
    M2.start()
    M2.join_chat("XD_CUTETY")

if M3:
    M3.start()
    M3.join_chat("XD_CUTETY")

if M4:
    M4.start()
    M4.join_chat("XD_CUTETY")

if M5:
    M5.start()
    M5.join_chat("XD_CUTETY")

print("hellPy Started Successfully")
